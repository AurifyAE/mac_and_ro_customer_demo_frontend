...
const countries = [
  ...
  'South Africa', 'Egypt', 'Nigeria', 'Kenya', 'UAE', 'Saudi Arabia',
...
const industries = [
  ...
  'Information and communication', 'Manufacturing', 'Real estate activities',
  'Transportation and storage', 'Wholesale and retail trade', 'Other'
];

const workTypes = [
  'Salaried-General', 'Self-Employed', 'Business Owner', 'Retired',
  'Student', 'Homemaker', 'Unemployed', 'Freelancer'
];
...
const KYCForm = () => {
 ...
 useEffect(() => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    submitData.append('dateOfBirth', formData.dateOfBirth); // Changed from age
      ...
      if (formData.sourceOfWealth && formData.sourceOfWealth.length > 0) {
        submitData.append('sourceOfWealth', JSON.stringify({
      ...
      if (formData.sourceOfFunds && formData.sourceOfFunds.length > 0) {
        submitData.append('sourceOfFunds', JSON.stringify({
      ...
      <div className="relative w-full max-w-4xl rounded-xl bg-white/10 backdrop-blur-lg border border-white/20 p-8 shadow-2xl">
        ...
        <div className="space-y-8 text-white">
          ...
          <div className="rounded-lg bg-white/5 p-6 border border-white/10">
            ...
            {errors.accountType && (
              <p className="mt-4 text-sm text-red-400 text-center">{errors.accountType}</p>
            )}
          </div>
  ...
  {errors.dateOfBirth && <p className="mt-1 text-sm text-red-400">{errors.dateOfBirth}</p>}
              ...
              <div>
                <label htmlFor="residence" className="mb-2 block text-sm font-medium">Country of Residence *</label>
                <div className="relative">
                  <select
                    id="residence"
                    name="residence"
  ...
  {errors.type && <p className="mt-1 text-sm text-red-400">{errors.type}</p>}
          ...
          <div className="rounded-lg bg-white/5 p-6 border border-white/10">
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
              <div>
                <label htmlFor="workType" className="mb-2 block text-sm font-medium">Work Type *</label>
                <div className="relative">
                  <select
                    id="workType"
                    name="workType"
                    ...
                    required
                  >
                    <option value="" className="bg-gray-800">Select work type</option>
                    {workTypes.map(type => (
          ...
          <div className="rounded-lg bg-white/5 p-6 border border-white/10">
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
              <div className="md:col-span-2">
                <label htmlFor="address" className="mb-2 block text-sm font-medium">Street Address *</label>
                <div className="relative">
                  <input
                    id="address"
                    name="address"
              ...
              <div>
                <label htmlFor="state" className="mb-2 block text-sm font-medium">State/Province</label>
                <div className="relative">
                  <input
                    id="state"
                    name="state"
              ...
              <div>
                <label htmlFor="postalCode" className="mb-2 block text-sm font-medium">Postal Code *</label>
                <div className="relative">
                  <input
                    id="postalCode"
                    name="postalCode"
              ...
              <div>
                <label htmlFor="isdCode" className="mb-2 block text-sm font-medium">Country Code</label>
                <div className="relative">
                  <input
                    id="isdCode"
                    name="isdCode"
          ...
          <div className="rounded-lg bg-white/5 p-6 border border-white/10">
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
              <div>
                <label htmlFor="anyPublicPos" className="mb-2 block text-sm font-medium">Do you hold any public position?</label>
                <select
                  id="anyPublicPos"
                  name="anyPublicPos"
              ...
              <div>
                <label htmlFor="posLastTwoMonths" className="mb-2 block text-sm font-medium">Position in last 2 months?</label>
                <select
                  id="posLastTwoMonths"
              ...
              <div>
                <label htmlFor="everPublicPosition" className="mb-2 block text-sm font-medium">Ever held public position?</label>
                <select
              ...
              <div>
                <label htmlFor="diplomaticImmunity" className="mb-2 block text-sm font-medium">Diplomatic immunity?</label>
                <select
              ...
              <div>
                <label htmlFor="relativeTwelveMonths" className="mb-2 block text-sm font-medium">Relative in position (12 months)?</label>
                <select
              ...
              <div>
                <label htmlFor="closeAssociateTwelveMonths" className="mb-2 block text-sm font-medium">Close associate (12 months)?</label>
                <select
              ...
              <div>
                <label htmlFor="conviction" className="mb-2 block text-sm font-medium">Any convictions?</label>
                <select
                  id="conviction"
                  name="conviction"
                  className="w-full rounded-lg bg-white/10 border border-white/20 px-4 py-3 text-white focus:border-blue-400 focus:outline-none focus:ring-2 focus:ring-blue-400/50"
              ...
              <div>
                <label htmlFor="other" className="mb-2 block text-sm font-medium">Other Information</label>
                <input
                  id="other"
                  name="other"
                  type="text"
          ...
          <div className="rounded-lg bg-white/5 p-6 border border-white/10">
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
              <div>
                <label htmlFor="idNumber" className="mb-2 block text-sm font-medium">National ID Number *</label>
                <div className="relative">
                  <input
                    id="idNumber"
                    name="idNumber"
              ...
              <div>
                <label htmlFor="idExpiryDate" className="mb-2 block text-sm font-medium">ID Expiry Date *</label>
                <div className="relative">
                  <input
                    id="idExpiryDate"
                    name="idExpiryDate"
              ...
              <div>
                <label htmlFor="passportNumber" className="mb-2 block text-sm font-medium">Passport Number (Optional)</label>
                <div className="relative">
                  <input
                    id="passportNumber"
                    name="passportNumber"
              ...
              <div>
                <label htmlFor="passportExpiryDate" className="mb-2 block text-sm font-medium">Passport Expiry Date</label>
                <div className="relative">
                  <input
