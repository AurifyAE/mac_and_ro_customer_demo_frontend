...
export const countries: Country[] = [
  ...
  { name: "Bermuda", code: "BM", phoneCode: "+1441", flag: "🇧🇲" },
  ...
  { name: "British Indian Ocean Territory", code: "IO", phoneCode: "+246", flag: "🇮🇴" },
  { name: "Brunei Darussalam", code: "BN", phoneCode: "+673", flag: "🇧🇳" },
  ...
  { name: "Cayman Islands", code: "KY", phoneCode: "+1345", flag: "🇰🇾" },
  ...
  { name: "Christmas Island", code: "CX", phoneCode: "+61", flag: "🇨🇽" },
  { name: "Cocos (Keeling) Islands", code: "CC", phoneCode: "+672", flag: "🇨🇨" },
  { name: "Colombia", code: "CO", phoneCode: "+57", flag: "🇨🇴" },
  { name: "Comoros", code: "KM", phoneCode: "+269", flag: "🇰🇲" },
  { name: "Congo", code: "CG", phoneCode: "+242", flag: "🇨🇬" },
  { name: "Congo, Democratic Republic", code: "CD", phoneCode: "+243", flag: "🇨🇩" },
  { name: "Cook Islands", code: "CK", phoneCode: "+682", flag: "🇨🇰" },
  { name: "Costa Rica", code: "CR", phoneCode: "+506", flag: "🇨🇷" },
  { name: "Cote D'Ivoire", code: "CI", phoneCode: "+225", flag: "🇨🇮" },
  ...
  { name: "Dominica", code: "DM", phoneCode: "+1767", flag: "🇩🇲" },
  { name: "Dominican Republic", code: "DO", phoneCode: "+1809", flag: "🇩🇴" },
  ...
  { name: "Falkland Islands (Malvinas)", code: "FK", phoneCode: "+500", flag: "🇫🇰" },
  { name: "Faroe Islands", code: "FO", phoneCode: "+298", flag: "🇫🇴" },
  { name: "Fiji", code: "FJ", phoneCode: "+679", flag: "🇫🇯" },
  { name: "Finland", code: "FI", phoneCode: "+358", flag: "🇫🇮" },
  { name: "France", code: "FR", phoneCode: "+33", flag: "🇫🇷" },
  { name: "French Guiana", code: "GF", phoneCode: "+594", flag: "🇬🇫" },
  ...
  { name: "Gibraltar", code: "GI", phoneCode: "+350", flag: "🇬🇮" },
  { name: "Greece", code: "GR", phoneCode: "+30", flag: "🇬🇷" },
  { name: "Greenland", code: "GL", phoneCode: "+299", flag: "🇬🇱" },
  { name: "Grenada", code: "GD", phoneCode: "+1473", flag: "🇬🇩" },
  { name: "Guadeloupe", code: "GP", phoneCode: "+590", flag: "🇬🇵" },
  { name: "Guam", code: "GU", phoneCode: "+1671", flag: "🇬🇺" },
  { name: "Guatemala", code: "GT", phoneCode: "+502", flag: "🇬🇹" },
  { name: "Guernsey", code: "GG", phoneCode: "+44", flag: "🇬🇬" },
  ...
  { name: "Holy See (Vatican City State)", code: "VA", phoneCode: "+39", flag: "🇻🇦" },
  ...
  { name: "Iran, Islamic Republic of", code: "IR", phoneCode: "+98", flag: "🇮🇷" },
  { name: "Iraq", code: "IQ", phoneCode: "+964", flag: "🇮🇶" },
  { name: "Ireland", code: "IE", phoneCode: "+353", flag: "🇮🇪" },
  { name: "Isle of Man", code: "IM", phoneCode: "+44", flag: "🇮🇲" },
  ...
  { name: "Jersey", code: "JE", phoneCode: "+44", flag: "🇯🇪" },
  ...
  { name: "Korea, Democratic People's Republic of", code: "KP", phoneCode: "+850", flag: "🇰🇵" },
  { name: "Korea, Republic of", code: "KR", phoneCode: "+82", flag: "🇰🇷" },
  { name: "Kuwait", code: "KW", phoneCode: "+965", flag: "🇰🇼" },
  { name: "Kyrgyzstan", code: "KG", phoneCode: "+996", flag: "🇰🇬" },
  { name: "Lao People's Democratic Republic", code: "LA", phoneCode: "+856", flag: "🇱🇦" },
  ...
  { name: "Libyan Arab Jamahiriya", code: "LY", phoneCode: "+218", flag: "🇱🇾" },
  ...
  { name: "Macao", code: "MO", phoneCode: "+853", flag: "🇲🇴" },
  ...
  { name: "Netherlands Antilles", code: "AN", phoneCode: "+599", flag: "🇦🇳" },
  ...
  { name: "Niue", code: "NU", phoneCode: "+683", flag: "🇳🇺" },
  { name: "Norfolk Island", code: "NF", phoneCode: "+672", flag: "🇳🇫" },
  { name: "Northern Mariana Islands", code: "MP", phoneCode: "+1670", flag: "🇲🇵" },
  ...
  { name: "Palestinian Territory, Occupied", code: "PS", phoneCode: "+970", flag: "🇵🇸" },
  ...
  { name: "Pitcairn", code: "PN", phoneCode: "+64", flag: "🇵🇳" },
  { name: "Poland", code: "PL", phoneCode: "+48", flag: "🇵🇱" },
  { name: "Portugal", code: "PT", phoneCode: "+351", flag: "🇵🇹" },
  { name: "Puerto Rico", code: "PR", phoneCode: "+1787", flag: "🇵🇷" },
  { name: "Qatar", code: "QA", phoneCode: "+974", flag: "🇶🇦" },
  { name: "Reunion", code: "RE", phoneCode: "+262", flag: "🇷🇪" },
  { name: "Romania", code: "RO", phoneCode: "+40", flag: "🇷🇴" },
  { name: "Russian Federation", code: "RU", phoneCode: "+7", flag: "🇷🇺" },
  { name: "Rwanda", code: "RW", phoneCode: "+250", flag: "🇷🇼" },
  { name: "Saint Helena", code: "SH", phoneCode: "+290", flag: "🇸🇭" },
  { name: "Saint Kitts and Nevis", code: "KN", phoneCode: "+1869", flag: "🇰🇳" },
  { name: "Saint Lucia", code: "LC", phoneCode: "+1758", flag: "🇱🇨" },
  { name: "Saint Pierre and Miquelon", code: "PM", phoneCode: "+508", flag: "🇵🇲" },
  { name: "Saint Vincent and the Grenadines", code: "VC", phoneCode: "+1784", flag: "🇻🇨" },
  ...
  { name: "South Georgia and the South Sandwich Islands", code: "GS", phoneCode: "+500", flag: "🇬🇸" },
  ...
  { name: "Turks and Caicos Islands", code: "TC", phoneCode: "+1649", flag: "🇹🇨" },
  ...
  { name: "United States Minor Outlying Islands", code: "UM", phoneCode: "+1", flag: "🇺🇲" },
  ...
  { name: "Viet Nam", code: "VN", phoneCode: "+84", flag: "🇻🇳" },
  { name: "Virgin Islands, British", code: "VG", phoneCode: "+1284", flag: "🇻🇬" },
  { name: "Virgin Islands, U.S.", code: "VI", phoneCode: "+1340", flag: "🇻🇮" },
  { name: "Wallis and Futuna", code: "WF", phoneCode: "+681", flag: "🇼🇫" },
  { name: "Western Sahara", code: "EH", phoneCode: "+212", flag: "🇪🇭" },
